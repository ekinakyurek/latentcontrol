...
.PHONY: env di cca all build-base build-torch build-train
.PHONY: all-full build-base-full build-torch-full build-train-full
...
all: env cca build-base build-torch build-train
...
CUDNN_VERSION     = 8
PYTHON_VERSION    = 3.8
MAGMA_VERSION     = 113  # Magma version must match CUDA version.
...
all-full: env cca build-base-full build-torch-full build-train-full
